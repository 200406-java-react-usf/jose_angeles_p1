...
describe('ReimbService', () => {
    ...
    let date = new Date();
    let mockReimbs = [
        new Reimbursement(1, 100, date, date, 'text', 'author-test', 2, 'pending', 'food'),
        new Reimbursement(2, 200, date, date, 'text', 'author-test', 2, 'approved', 'food'),
        new Reimbursement(3, 300, date, date, 'text', 'author-test', 2, 'approved', 'food'),
        new Reimbursement(4, 400, date, date, 'text', 'author-test', 2, 'denied', 'food'),
        new Reimbursement(5, 500, date, date, 'text', 'author-test', 2, 'denied', 'food')
    ];
    ...
    test('should addNew to Reimb', async () => {
        ...
        // Act
        let newReimb = new Reimbursement(6, 100, date, date, 'text', 'author-test', 2, 'pending', 'food');
    ...
    test('should reject with BadRequestError if invalid reimb', async () => {
        ...
        // Act
        let newReimb = new Reimbursement(6, 500, date, null, 'text', 'author-test', 2, 'approved', 'food');
    ...
    test('should reject with BadRequestError if invalid id', async () => {
        ...
        // Act
        let newReimb = new Reimbursement(7, 500, date, date, 'text', 'author-test', 2, 'approved', 'food');
    ...
    test('should reject with ResourcePersistenceError if invalid reimb', async () => {
        ...
        let newReimb = new Reimbursement(6, 500, date, date, 'text', 'author-test', 2, null, 'food');
    ...
    test('should reject with ResourcePersistenceError if invalid id', async () => {
        ...
        // Act
        let newReimb = new Reimbursement(null, 500, date, date, 'text', 'author-test', 2, null, 'food');
    ...
    test('should reject with ResourcePersistenceError if invalid status', async () => {
        ...
        let newReimb = new Reimbursement(1, 500, date, date, 'text', 'author-test', 2, "test", 'food');
